...
// Quando uma avaliacao é criada/editada/alterada, este trigger recalcula a nota media do professor
// E tambem solicita um novo resumo ao Gemini, caso as condicoes sejam satisfeitas
export const avaliacaoDocente = firestore.onDocumentWritten(
    {
